...
#          -> button animateTo right bottom corner (text: continue)
      ...
      //sitzeinstellungen#3 (TODO: JONI)
          //favoriten als knopf, wo man dann eine liste angezeigt bekommt mit eigenen namen einstellen
#      globaler stoppknopf
      wenn longpress auf choice chip, dann dialog ob neuer favorit gesetzt werden soll
      wenn preset ausgewählt wird, animateTo mit kondensator funktion
      sitzposition animieren ->
            3 versch. lines
              wenn change, dann rot makieren
          change-> dispose, draw new line
    ...
    daten persistent speichern -> sharedPreferences (video gucken)
      lang bei init rausziehen, bei auswahl selecten
    schriftart huebsch

    verschieden themes :  snooze theme   56, 199, 239
                          dark theme
                          ligth theme
                          custom 
          anwenden auf menubar, bottomnavbar, 
          tabview andere schattierung

    dummieserver antesten
    doku schreiben
    review bei nächster abgabe
*/
